...
<br>
<p>Run Zigbee2mqtt as a Home Assistant Add-on</p>
</div>
...
- To find out which serial ports you have exposed go to **Supervisor (used to be Home Assistant) > System > Host system > Hardware**
